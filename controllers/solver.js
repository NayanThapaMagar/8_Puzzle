module.exports = async (req, res) => {
    ...
    function solvePuzzleBFS(initialState, goalState) {
        ...
        while (queue.length > 0) {
            ...
            // If the current node's level matches the currentLevel, generate child nodes
            if (currentNode.level === currentLevel) {
                ...
                // If the current node's level is different, update the currentLevel
    ...
    const solutionPathBFS = solvePuzzleBFS(initialState, goalState);
    ...
    const solutionPathDFS = solvePuzzleDFS(initialState, goalState);
...
// export const bfs: RequestHandler = async (req, res) => {
